...
public class Uzhin extends ListFragment {
    ...
    public static Uzhin newInstance(String param1, String param2) {
        Uzhin fragment = new Uzhin();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dishArrayList = filterbytime(dbMenu.selectAll(), 2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_uzhin, container, false);
    }
